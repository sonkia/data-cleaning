...
@Slf4j
public class DateFormatMaterial {
    ...
    public DateFormatMaterial(String expandedName, String bashPath, String sourcePath, String targetPath, boolean existTitle) {
        ...
        try {
            ...
            while ((str = bufferedReader.readLine()) != null) {
                ...
                if (counter == 0) {
                    ...
                    if (existTitle) {
                        //写文件头
                        StringBuffer st = new StringBuffer(strings[0]);
                        for (int i = 1; i < strings.length; i++) {
                            st.append(",").append(strings[i]);
                        }
                        fileWritter.write(st.toString() + "\n");
                        continue;
                    }
                }
